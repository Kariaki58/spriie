...
const sidebarConfig = {
    navItems: [
        { href: '/dashboard/vendor', label: 'Dashboard', icon: <Home className="w-5 h-5" /> },
        { href: '/dashboard/analytics', label: 'Analytics', icon: <BarChart2 className="w-5 h-5" /> },
        { href: '/dashboard/content', label: 'content', icon: <TableOfContents className="w-5 h-5"/> },
        { href: '/dashboard/content-upload', label: 'Content Upload', icon: <MonitorUp className="w-5 h-5" /> },
        { href: '/dashboard/products', label: 'Products', icon: <Package className="w-5 h-5" /> },
        { href: '/dashboard/product-upload', label: 'Product Upload', icon: <CloudUpload className="w-5 h-5"/> },
